...
- Website: [agenticailab.org](https://agenticailab.org)
- Roadmap: [agenticailab.org/roadmap](https://agenticailab.org/roadmap)
- GitHub: [chaitanya-y/agentic-ai-lab](https://github.com/chaitanya-y/agentic-ai-lab)
...
7. Customer Service Agent Capstone
